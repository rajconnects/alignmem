...
2. Once you have the fields, output the trace inside a fenced JSON code block.
3. Below the code block, instruct me: *"Save this as `<trace_id>.json` and import it into your Decision Journal."*
4. If ChatGPT's file-creation feature is available in this conversation, offer the JSON as a downloadable file instead of a code block.
